...
import { FormField, ErrorBox, Loader } from "../../components";
...
const ListNFTModal = ({ isOpen, closeModal, tokenId }) => {
    ...
    >
      <div className=" flex flex-col bg-black rounded-[10px] mx-auto sm:p-10 p-4 w-[80%]">
        ...
        >
          <div className="flex">
            <FormField
              labelName="Selling Price in MATIC"
              inputType="number"
              value={sellingPrice}
              handleChange={(e) => {
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex gap-20 mt-6">
              ...
              <p className="text-gray-300">{sellingPrice} MATIC</p>
            </div>
            <div className="flex gap-20 mt-6">
            ...
            <div className="flex gap-20 mt-10">
              ...
              <p className="text-gray-300">
                {(sellingPrice * 0.95).toFixed(2)} MATIC
              </p>
            </div>
          </div>
